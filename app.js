...
app.use(express.urlencoded({ extended: true }));  //False yerine true yaptık kullanabilmek icin
...
app.use((err, req, res, next)=> {
  ...
  res.json({error : err.message , code: err.code});    //Bir hata donmesi durumunda burada ne dondurulecegi belirleniyor (movie dosyasindaki mesaj donuyor)
});
